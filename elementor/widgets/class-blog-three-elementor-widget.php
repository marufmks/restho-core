                    ...
                    <?php
                        ...
                        <div class="h3-blog-wrap-1">
                            ...
                            <div class="blog-content">
                                ...
                                <h3><a href="<?php echo esc_url($post_data[0]['permalink'] ?? ''); ?>"><?php echo esc_html($post_data[0]['title']); ?></a></h3>
                        ...
                        <div class="row">
                            <div class="col-xxl-12 col-xl-6 col-lg-6 col-sm-6 ">
                                <div class="blog-card-alfa one">
                                    <div class="blog-content">
                                        <h3><a href="<?php echo esc_url($post_data[1]['permalink'] ?? ''); ?>"><?php echo esc_html($post_data[1]['title']); ?></a></h3>
                            ...
                            <div class="col-xxl-12 col-xl-6 col-lg-6 col-sm-6 ">
                                <div class="blog-card-alfa">
                                    ...
                                    <div class="blog-content">
                                        <h3><a href="<?php echo esc_url($post_data[2]['permalink'] ?? ''); ?>"><?php echo esc_html($post_data[2]['title']); ?></a></h3>
