...
class Restho_Food_Item_Carousel_Widget extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $repeater3->add_control(
            'restho_section_content_food_it_caro_st_three_category',
            [
                'label' => esc_html__('Category', 'restho-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Sea-Fish Food', 'restho-core'),
                'label_block' => true,
            ]
        );
        $repeater3->add_control(
        ...
        $this->end_controls_section();
         //Category
         $this->start_controls_section(
            'restho_food_itm_sty_three_category',
            [
                'label' => esc_html__('Category', 'restho-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_control(
            'restho_food_itm_sty_three_category_color',
            [
        ...
        $this->add_control(
            'restho_food_itm_sty_three_category_hvr_color',
            [
                'label'     => esc_html__('Hover', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .populer-food-area .h3-popular-food-card .food-content .food-cetagory a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'restho_food_itm_sty_three_category_hvr_bg_color',
            [
                'label'     => esc_html__('BG Hover', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .populer-food-area .h3-popular-food-card .food-content .food-cetagory a:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_food_itm_sty_three_category_typography',
                'selector' => '{{WRAPPER}} .populer-food-area .h3-popular-food-card .food-content .food-cetagory a',
            ],
        );
        $this->add_responsive_control(
            'restho_food_itm_sty_three_category_padding',
            [
                'label'      => __('Padding', 'restho-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .populer-food-area .h3-popular-food-card .food-content .food-cetagory a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ]
            ]
        );
        $this->add_responsive_control(
            'restho_food_itm_sty_three_category_margin',
            [
                'label' => esc_html__('Margin', 'restho-core'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .populer-food-area .h3-popular-food-card .food-content .food-cetagory a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
                                        ...
                                        <div class="h3-popular-food-card">
                                            ...
                                            <div class="food-content">
                                                <div class="food-cetagory">
                                                    <?php if (!empty($item3['restho_section_content_food_it_caro_st_three_category'])) : ?>
                                                        <a><?php echo wp_kses($item3['restho_section_content_food_it_caro_st_three_category'], wp_kses_allowed_html('post')) ?></a>
                                                    <?php endif ?>
                                                </div>
