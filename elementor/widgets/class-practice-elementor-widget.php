...
class restho_Practice_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'restho_practice_area';
    }

    public function get_title()
    {
        return esc_html__('EG Practice Area', 'restho-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'restho_projects_general_section',
            [
                'label' => esc_html__('General', 'restho-core')
            ]
        );
        $this->add_control(
            'restho_practice_general_section_selection',
            [
		...
		$this->add_control(
			'restho_practice_design_three_card_design_choose_content',
			[
				'label' => esc_html__( 'Card Background Light ON/OFF', 'restho-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'shadow_on' => esc_html__( 'Black', 'restho-core' ),
				'shadow_off' => esc_html__( 'White', 'restho-core' ),
				'return_value' => 'yes',
				'default' => 'yes',
                'condition' => [
                    'restho_practice_general_section_selection' => 'style_three',
                ],
			]
		);
        $this->add_control(
			'restho_pracrice_template_posts_per_page',
			[
		...
		$this->add_control(
			'restho_practice_template_orderby',
			[
		...
		$this->add_control(
			'restho_practice_template_order',
			[
        ...
        //Content Section
        $this->start_controls_section(
            'restho_practice_area_title_subtitle',
            [
                'label' => esc_html__('Content', 'restho-core'),
                'condition' => [
                    'restho_practice_general_section_selection' => 'style_two'
                ]
            ]
        );
        ...
        $this->add_control(
            'restho_practice_area_title_subtitle_section',
            [
        ...
        $this->add_control(
            'restho_practice_area_title_title_section',
            [
        ...
        $this->add_control(
            'restho_practice_area_right_image',
            [
                'label' => esc_html__( 'Choose Image', 'restho-core' ),
        ...
        //Icon Style
        $this->start_controls_section(
            'restho_practice_style_icon',
            [
            'label' => esc_html__('Icon', 'restho-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
                'restho_practice_general_section_selection' => 'style_one'
            ]
            ]
        );
        $this->add_control(
            'restho_practice_style_icon_color',
            [
        ...
        $this->add_control(
            'restho_practice_style_icon_hover_color',
            [
        ...
        //Button Style
        $this->start_controls_section(
            'restho_practice_style_button_section',
            [
        ...
        $this->add_control(
            'restho_practice_style_button_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_style_button_background',
            [
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'restho_practice_style_button_border',
                'selector' => '{{WRAPPER}} .btn--outline',
            ]
        );
        $this->add_responsive_control(
			'restho_practice_style_button_border_radius',
			[
			'restho_practice_style_button_border_radius',
        ...
        $this->add_control(
            'restho_practice_style_button_hover_color',
            [
        ...
        $this->add_control(
            'restho_practice_style_button_hover_background',
            [
                'label'     => esc_html__('Hover Primary Background', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .btn--primary:hover' => 'color: {{VALUE}};',
        ...
        $this->add_control(
            'restho_practice_style_button_hover_background_secondary',
            [
                'label'     => esc_html__('Hover Secondary Background', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_style_title_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'restho_practice_style_title_typ',
        ...
        $this->add_control(
            'restho_practice_style_title_margin',
            [
        ...
        $this->add_control(
            'restho_practice_style_title_hover_color',
            [
        ...
        //Description Style
        $this->start_controls_section(
            'restho_practice_area_style_description',
            [
        ...
        $this->add_control(
            'restho_practice_style_description_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_style_description_typ',
                'selector' => '{{WRAPPER}} .practice-single .body p',
        
            ]
        );
        $this->add_control(
            'restho_practice_style_description_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_control(
            'restho_practice_style_description_hover_color',
            [
                'label' => esc_html__( 'Description Hover', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
             'restho_practice_area_style_one_learn_more_btn',
             [
                'label' => esc_html__('Learn More Button', 'restho-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'restho_practice_general_section_selection' => 'style_one'
                ]
        ...
        $this->add_control(
            'restho_practice_style_one_learn_more_btn_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_style_one_learn_more_btn_typ',
                'selector' => '{{WRAPPER}} .practice-single .body .details-btn',
        
            ]
        );
        $this->add_control(
            'restho_practice_style_one_learn_more_btn_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        //Hover start
        $this->add_control(
            'restho_practice_style_one_learn_more_btn_short_bar_color',
            [
                'label'     => esc_html__('Short Bar', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_style_one_larn_more_btn_long_bar_color',
            [
                'label'     => esc_html__('Short Bar', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        //Card content start
        $this->start_controls_section(
            'restho_practice_area_style_card_content',
            [
        ...
        $this->add_control(
            'restho_practice_area_style_card_content_header_background',
            [
                'label'     => esc_html__('Header Background', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        //Hover start
        $this->add_control(
            'restho_practice_area_style_card_content_header_hover',
            [
                'label' => esc_html__( 'Header Hover', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_area_style_card_content_body_background',
            [
                'label'     => esc_html__('Body Background', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_area_style_card_content_body_hover',
            [
                'label' => esc_html__( 'Body Hover', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_top_title_typ',
        ...
        $this->add_control(
            'restho_practice_top_title_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_top_title_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_control(
            'restho_practice_subtitle_border_color',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_top_subtitle_typ',
        ...
        $this->add_control(
            'restho_practice_top_subtitle_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_top_subtitle_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        //Icon Style
        $this->start_controls_section(
            'restho_practice_style_two_icon',
            [
            'label' => esc_html__('Icon', 'restho-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
        ...
        $this->add_control(
            'restho_practice_style_two_icon_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        //SL Style
        $this->start_controls_section(
            'restho_practice_style_sl_no',
            [
            'label' => esc_html__('Sl No', 'restho-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
                'restho_practice_general_section_selection' => 'style_two'
            ]
        ...
        $this->add_control(
            'restho_practice_style_sl_no_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_style_sl_no_typ',
                'selector' => '{{WRAPPER}} .practice-single2 .sl-number',
        
            ]
        );
        $this->add_control(
            'restho_practice_style_sl_no_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        //title style two
        $this->start_controls_section(
            'restho_practice_style_two_title',
            [
            'label' => esc_html__('Title', 'restho-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_style_two_title_typ',
        ...
        $this->add_control(
            'restho_practice_style_two_title_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_style_two_title_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_section(
            'restho_practice_style_two_description',
            [
            'label' => esc_html__('Description', 'restho-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
        ...
        $this->add_control(
            'restho_practice_style_two_description_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_style_two_description_typ',
        ...
        $this->add_control(
            'restho_practice_style_two_description_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_section(
            'restho_practice_style_two_learn_more_btn',
            [
            'label' => esc_html__('Learn More Button', 'restho-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
        ...
        $this->add_control(
            'restho_practice_style_two_learn_more_btn_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_style_two_learn_more_btn_typ',
        ...
        $this->add_control(
            'restho_practice_style_two_learn_more_btn_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_control(
            'restho_practice_style_two_learn_more_btn_short_bar_color',
            [
                'label'     => esc_html__('Short Bar', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_style_two_learn_more_btn_long_bar_color',
            [
                'label'     => esc_html__('Long Bar', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        //Icon Style three
        $this->start_controls_section(
            'restho_practice_style_three_icon',
            [
                'label' => esc_html__('Icon', 'restho-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_control(
            'restho_practice_style_three_icon_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_style_three_icon_background',
            [
                'label'     => esc_html__('Background', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        //title style three
        $this->start_controls_section(
            'restho_practice_style_three_title',
            [
            'label' => esc_html__('Title', 'restho-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
        ...
        $this->add_control(
            'restho_practice_style_three_title_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_style_three_title_typ',
                'selector' => '{{WRAPPER}} .practice-single3 .practice-content h4',
        
            ]
        );
        $this->add_control(
            'restho_practice_style_three_title_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_section(
            'restho_practice_style_three_description',
            [
                'label' => esc_html__('Description', 'restho-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_control(
            'restho_practice_style_three_description_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_style_three_description_typ',
        ...
        $this->add_control(
            'restho_practice_style_three_description_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->start_controls_section(
            'restho_practice_style_three_learn_more_btn',
            [
            'label' => esc_html__('Learn More Button', 'restho-core'),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
        ...
        $this->add_control(
            'restho_practice_style_three_learn_more_btn_color',
            [
                'label'     => esc_html__('Color', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'restho-core'),
                'name'     => 'restho_practice_style_three_learn_more_btn_typ',
        ...
        $this->add_control(
            'restho_practice_style_three_learn_more_btn_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
        ...
        $this->add_control(
            'restho_practice_style_three_learn_more_btn_short_bar_color',
            [
                'label'     => esc_html__('Short Bar', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'restho_practice_style_three_learn_more_btn_long_bar_color',
            [
                'label'     => esc_html__('Long Bar', 'restho-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        //Card content start
        $this->start_controls_section(
            'restho_practice_area_style_three_card_content',
            [
               'label' => esc_html__('Card', 'restho-core'),
               'tab'   => Controls_Manager::TAB_STYLE,
               'condition' => [
        ...
        $this->add_control(
            'restho_practice_area_style_three_card_background',
            [
        ...
        //Hover start
        $this->add_control(
            'restho_practice_area_style_three_card_hover',
            [
        ...
        $this->add_responsive_control(
			'restho_practice_area_style_three_card_border_radius',
			[
			'restho_practice_area_style_three_card_border_radius',
				'label'      		=> __('Border Radius', 'restho-core'),
				'type'       		=> Controls_Manager::DIMENSIONS,
        ...
        $this->add_control(
            'restho_practice_area_style_three_card_border_margin',
            [
                'label' => esc_html__( 'Margin', 'restho-core' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
    ...
    protected function render()
    {
        ...
        $query = new \WP_Query(
			array(
				...
				'posts_per_page' => $settings['restho_pracrice_template_posts_per_page'],
				'orderby'        => $settings['restho_practice_template_orderby'],
				'order'          => $settings['restho_practice_template_order'],
        ...
        <!-- content one-->
            <?php if ( $settings['restho_practice_general_section_selection'] == 'style_one' ) : ?>
                                    ...
                                    <div class="practice-single <?php echo ( ($count%2) == 0) ? 'sibling1' : 'sibling0' ?>  wow fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                        <div class="header">
                                            <div class="icon-area">
                                                ...
                                                <?php endif ?>
                                                <a href="<?php the_permalink()?>" class="eg-btn btn--primary btn--outline btn--sm capsule <?php echo ( ($count%2) == 0) ? 'btnn1' : 'btnn0' ?>"><?php echo esc_html__('Completed Case','restho-core')?> <?php echo esc_html( $practice_info['project_complete_number']) ?></a>
                                            </div>
                                            <h4><a href="<?php the_permalink()?>"><?php the_title()?></a></h4>
                                        </div>
                                        <div class="body">
                                            <p><?php echo wp_trim_words( get_the_content(), 15 ); ?></p>
                                            <a href="<?php the_permalink()?>" class="details-btn"><?php echo esc_html__('Learn More','restho-core')?></a>
                                        </div>
                                    </div>
                                </div>
        ...
        <!-- content two-->
            <?php if ( $settings['restho_practice_general_section_selection'] == 'style_two' ) : ?>
                        ...
                        <div class="row align-items-end">
                            <div class="col-xl-6 overflow-hidden position-relative">
                                <div class="section-title2 sibling3 text-xl-start text-center">
                                    <?php if( !empty( $settings['restho_practice_area_title_subtitle_section'] ) ) :   ?>
                                        <span><?php echo esc_html($settings['restho_practice_area_title_subtitle_section'] )?></span>         
                                    <?php endif ?>
                                    <?php if( !empty( $settings['restho_practice_area_title_title_section'] ) ) :   ?>
                                          <h2><?php echo esc_html($settings['restho_practice_area_title_title_section'] )?></h2>          
                                    <?php endif ?>
                                </div>
                            ...
                            <div class="col-xl-6 d-xl-flex d-none">
                                <?php if( !empty( $settings['restho_practice_area_right_image']['url'] ) ) :   ?>
                                       <img src="<?php echo esc_url($settings['restho_practice_area_right_image']['url'])?>" class="img-fluid" alt="image">         
                                <?php endif ?>
                            </div>
                        </div>
					</div>
        ...
        <!-- content three-->
            <?php if ( $settings['restho_practice_general_section_selection'] == 'style_three' ) : ?>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <!-- Content -->
                                            ...
                                            <div class="swiper-slide wow fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                                <div class="practice-single3 <?php echo $settings['restho_practice_design_three_card_design_choose_content'] == 'yes' ? 'sibling2' : '' ?>">
...
Plugin::instance()->widgets_manager->register(new restho_Practice_Widget());
