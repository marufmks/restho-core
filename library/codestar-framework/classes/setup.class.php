...
if( ! class_exists( 'CSF' ) ) {
  class CSF {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      wp_enqueue_style( 'csf', EGNS_CORE_ROOT_URL . 'library/codestar-framework/assets/css/csf'. $min .'.css' , array(), '1.0.0', 'all' );

      // rtl styles
      if ( is_rtl() ) {
        wp_enqueue_style( 'csf-rtl', EGNS_CORE_ROOT_URL . 'library/codestar-framework/assets/css/csf-rtl'. $min .'.css' , array(), '1.0.0', 'all' );
      }

      // framework core scripts
      wp_enqueue_script( 'csf-plugins',EGNS_CORE_ROOT_URL . 'library/codestar-framework/assets/js/csf-plugins'. $min .'.js' , array(), '1.0.0', true );
      wp_enqueue_script( 'csf',EGNS_CORE_ROOT_URL . 'library/codestar-framework/assets/js/csf'. $min .'.js' , array( 'csf-plugins' ), '1.0.0', true );
