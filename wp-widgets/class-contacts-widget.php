...
class Egens_Contacts extends WP_Widget {
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo $this->get_field_id('contact_number_one'); ?>"
                   name="<?php echo $this->get_field_name('contact_number_one'); ?>" type="text"
                   value="<?php echo esc_attr($contact_number_one); ?>"/>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('contact_number_two'); ?>"><?php _e('Contact Number Two:', 'egens-core'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('contact_number_two'); ?>"
                   name="<?php echo $this->get_field_name('contact_number_two'); ?>" type="text"
                   value="<?php echo esc_attr($contact_number_two); ?>"/>
        </p>

        <p>
            <label for="<?php echo $this->get_field_id('email_one'); ?>"><?php _e('Email One:', 'egens-core'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('email_one'); ?>"
                   name="<?php echo $this->get_field_name('email_one'); ?>" type="text"
                   value="<?php echo esc_attr($email_one); ?>"/>
        </p>
        
        <p>
            <label for="<?php echo $this->get_field_id('email_two'); ?>"><?php _e('Email Two:', 'egens-core'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('email_two'); ?>"
                   name="<?php echo $this->get_field_name('email_two'); ?>" type="text"
                   value="<?php echo esc_attr($email_two); ?>"/>
        </p>
